...
#define txPin 10
#define RECV_PIN 4
#define default_relay 6                                                                                                 //Pin of relay 1 (rel[0])
#define second_relay 7                                                                                                  //Pin of relay 2 (rel[1])
...
void setup ()
  ...
  */
  ...
  /*********PLEASE HERE DECLARE THE PIN'S AND THE DESCRIPTION OF THE RELAYS, ONE EACH REL[] STRUCTURE*******/
  //example : rel[].socket = pin connected to relay ;
  rel[0].socket = default_relay;
  rel[0].description = 1;
  
  rel[1].socket = second_relay;
  rel[1].description = 3;
