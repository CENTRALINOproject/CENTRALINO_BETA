...
void set_timer_off()
{
  ...
  Serial.print(rel[function_temp.extra_value].timer_off_hour);
  Serial.print(":");
  Serial.print(  rel[function_temp.extra_value].timer_off_minute );
  Serial.print(":");
  Serial.println(  rel[function_temp.extra_value].timer_off_second );
...
void set_timer_on()
{
  ...
  Serial.println("------------- Timer before adjust is at :");
  Serial.print(rel[function_temp.extra_value].timer_on_hour);
  Serial.print(":");
  Serial.print(  rel[function_temp.extra_value].timer_on_minute );
  Serial.print(":");
  Serial.println(  rel[function_temp.extra_value].timer_on_second );
